...
- DATE_FORMAT을 이용한 쿼리
- DATE_FORMAT(변경하고자 하는 DATE 값, pattern)으로 풀 수 있음
```

> DATE_FORMAT 패턴 

![image-20211009201120785](C:\Users\USER\AppData\Roaming\Typora\typora-user-images\image-20211009201120785.png)